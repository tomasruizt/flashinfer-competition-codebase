...
I built several kernel variants (2 Triton, multiple CUDA), with the best achieving achieving up to ~265x speedup over PyTorch eager and outperforming the FlashInfer baseline.
...
| fi-baseline   | 5.42 us  | 8.27 us  | N/A      |
